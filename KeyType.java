        ...
        implements Comparable <KeyType>, Serializable
{
    ...
    public static void main (String [] args)
    {
        ...
        out.println ();
        out.println (STR."key1 = \{key1}");
        out.println (STR."key2 = \{key2}");
        out.println (STR."key3 = \{key3}");
        out.println ();
        out.println (STR."key1 < key2:  \{key1.compareTo (key2) < 0}");
        out.println (STR."key1 == key2: \{key1.compareTo (key2) == 0}");
        out.println (STR."key1 > key2:  \{key1.compareTo (key2) > 0}");
        out.println ();
        out.println (STR."key2 < key1:  \{key2.compareTo (key1) < 0}");
        out.println (STR."key2 == key1: \{key2.compareTo (key1) == 0}");
        out.println (STR."key2 > key1:  \{key2.compareTo (key1) > 0}");
        out.println ();
        out.println (STR."key1 < key3:  \{key1.compareTo (key3) < 0}");
        out.println (STR."key1 == key3: \{key1.compareTo (key3) == 0}");
        out.println (STR."key1 > key3:  \{key1.compareTo (key3) > 0}");
        out.println ();
        out.println (STR."key1.equals (key2): \{key1.equals (key2)}");
        out.println (STR."key1.equals (key3): \{key1.equals (key3)}");
        out.println (STR."key1.hashCode () == key2.hashCode (): \{key1.hashCode () == key2.hashCode ()}");
        out.println (STR."key1.hashCode () == key3.hashCode (): \{key1.hashCode () == key3.hashCode ()}");
    } // main
